          ...
          <TextBlock>
            <div>
              <Heading>
                <span>NeuraFi: </span>
                <br></br>
                <GradientText>AI-Powered DeFi,</GradientText>
                <GradientText>Trading, Secure and Non-Custodial: </GradientText>
              </Heading>
              <div>
                <Paragraph>
                  ...
                  <b>Trade Smarter , Not Harder</b> <br></br> NeuraFi combines
                  cutting-edge AI with non-custodial security to deliver a
                  seamless, intelligent trading experience across multiple
                  blockchains. Built on Solana and powered by DeepSeek AI,
                  we&apso;re redefining how you interact with DeFi.
                </Paragraph>
                {/* <Paragraph>
            ...
            <div>
              <JoinVersabotV
                ...
                target="_blank"
              >
                <Button>START TRADING WITH Neurafi</Button>
              </JoinVersabotV>
            </div>
          </TextBlock>
        </HeroSection>

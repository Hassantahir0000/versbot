      ...
      <Banner>
        ...
        >
          ...
          >
            ...
            <BannerSubtitles>
              <BannerSubtitleItems>
                NeuraFi combines the power of Artificial Intelligence with the
                security and convenience of a non-custodial Telegram bot and a
                web app. Our platform offers traders a simple, intuitive
                interface to manage digital assets, execute trades, and access
                advanced DeFi tools—all within the familiar environment of
                Telegram or through our web app.
              </BannerSubtitleItems>
        ...
        >
          ...
          >
            ...
            >
              <NumberPoint src="/images/2.png" alt="" />
              <TextPoint
                style={{
                  margin: "0",
                  lineHeight: "40px",
            ...
            >
              <NumberPoint src="/images/3.png" alt="" />
              <TextPoint
                style={{
                  margin: "0",
                  lineHeight: "40px",

...
const VideoShowCaseComponent: NextPage<VideoShowCaseComponentType> = ({
  ...
  const features = [
    ...
    {
      iconSrc: "/timeline@2x.png",
      title: "Seamless Swaps & Token Discovery",
      video:
        "https://res.cloudinary.com/versadex/video/upload/v1718891417/buy-fiat.mov",
      description:
        "Discover new tokens and execute swaps effortlessly with AI-powered recommendations. Our system integrates insights from top platforms like Token Sniffer, Dextools, Dexscreener, and major blockchain explorers, ensuring you get the most relevant and up-to-date token information.",
    },
    {
      iconSrc: "/timeline@2x.png",
      title: "Intelligent Market Sentiment Analysis",
      video:
        "https://res.cloudinary.com/versadex/video/upload/v1718891567/swap.mov",
      description:
        "Stay ahead of the market with real-time sentiment analysis from news and social media. Our AI scans thousands of sources to help you gauge market sentiment and make informed trading decisions—right from your Telegram chat.",
    },
    {
      iconSrc: "/timeline@2x.png",
      title: "Advanced Deep Learning Networks (Coming Soon)",
      video:
        "https://res.cloudinary.com/versadex/video/upload/v1718891567/swap.mov",
      description: `Leverage cutting-edge AI pattern recognition to identify market trends and optimize your trades. Our deep learning models continuously analyze data, helping you stay ahead of the curve in the ever-evolving DeFi space.
`,
    },
  ];
  ...
  return (
    <Section06FeaturesWrapperRoot className={className}>
      <Section06Features>
        ...
        <VideoIcon src="/images/neurafi.png" />

      ...
      <Banner>
        <Content>
          <Text1>
            ...
            <CallToAction1>
              NeuraFi harnesses AI to provide advanced trading strategies
              seamlessly across Telegram and our web app. Whether you're
              analyzing market data, predicting trends, or executing trades, our
              AI-powered tools ensure you stay ahead of the market—no matter
              where you trade.
            </CallToAction1>
          </Text1>

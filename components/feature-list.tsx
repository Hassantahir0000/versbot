        ...
        <FeatureItems>
          <FeatureContainer>
            <Feature1>
              ...
              <FeatureDescription>
                Instantly connect your DeFi wallet and start trading securely
            ...
            <DIcon className="animate-on-scroll">
              <IconBackground>
                <WalletColor1Icon
                  loading="lazy"
                  alt=""
                  src="/images/walletcolor-1@2x.png"
                />
                {/* <Shadow /> */}
                <NewWalletCoin1Icon
                  alt=""
                  src="/images/newwalletcoin-1@2x.png"
                />
              </IconBackground>
            </DIcon>
          </FeatureContainer>
          <Feature1>
            <H>Telegram Bot and Web App Trading</H>
            <FeatureDescription>
              Trade on the go with our AI-powered Telegram bot, or use our
              full-featured web app for in-depth analysis and advanced trading.
            </FeatureDescription>
            <DIcon1
              className="animate-on-scroll"
              loading="lazy"
              alt=""
              src="/images/3d-icon-04@2x.png"
            />
          </Feature1>
        </FeatureItems>
        <FeatureItems1>
          <FeatureContainer1>
            <FeatureContainer>
              <Feature2>
                ...
                <FeatureDescription1>
                  Leverage real-time AI-driven insights to execute smarter swaps
                  and trades across EVM and Solana blockchains.
                </FeatureDescription1>
                <VAsset />
              </Feature2>
              <DIcon
              ...
              >
                <IconBackground1>
                  <Swap1Icon alt="" src="/images/newswapcoin-1@2x.png" />
                  {/* <Shadow1 /> */}
                  {/* <NewSwapCoin1Icon
                    loading="lazy"
                    alt=""
                    src="/images/newswapcoin-1@2x.png"
                  /> */}
                </IconBackground1>
              </DIcon>
            </FeatureContainer>
            ...
            >
              <Feature3>
                <H>Advanced DeFi Tools & Yield Optimization</H>
                <FeatureDescription>
                  Access lending, borrowing, perpetual trading, and AI-driven
                  yield farming optimization to maximize your DeFi
                  opportunities.
                </FeatureDescription>
              </Feature3>
              <DIcon className="animate-on-scroll">
                <NewPerpCoin2Parent>
                  {/* <NewPerpCoin2Icon alt="" src="/images/newperpcoin-1@2x.png" />
                  <Shadow2 /> */}
                  <NewPerpCoin1Icon
                    loading="lazy"
                    alt=""
                    src="/images/newperpcoin-1@2x.png"
                  />
                </NewPerpCoin2Parent>
              </DIcon>
            </FeatureContainer>
        ...
        <FeatureItems>
          <FeatureContainer className="last">
            <Feature1>
              <H>
                ...
                <BuyCrypto>Crypto Purchases</BuyCrypto>
              </H>
              <FeatureDescription1>
                Easily buy crypto using credit cards or bank transfers, bridging
                traditional finance with DeFi.
              </FeatureDescription1>
            </Feature1>
            <DIcon className="animate-on-scroll">
              <IconBackground2>
                <Card1Icon loading="lazy" alt="" src="/images/card-1@2x.png" />
                {/* <Shadow3 />
          ...
          <FeatureContainer className="last">
            <Feature1>
              ...
              <FeatureDescription>
                Seamlessly swap and trade assets across EVM and Solana chains,
                with DeepSeek-powered cross-chain analytics for enhanced
                decision-making.
              </FeatureDescription>
              <DIcon
                className="animate-on-scroll"
              ...
              >
                <BridgeColor2Parent>
                  <BridgeColor2Icon alt="" src="/images/bridgecolor-2@2x.png" />
                  {/* <Shadow4 />
                  <NewHeroCoin21Icon
                    loading="lazy"
                    alt=""
                    src="/images/bridgecolor-2@2x.png"
                  /> */}
                </BridgeColor2Parent>
              </DIcon>
            </Feature1>
